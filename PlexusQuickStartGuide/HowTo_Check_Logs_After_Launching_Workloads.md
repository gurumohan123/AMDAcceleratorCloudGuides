...
Select any completed workload from the list of workloads(for Ex: Gromacs 2022_3-1690169305484)
...
Click on Syslog and scroll down for "Show historical logs" option to download the daemon logs.
![syslog](https://github.com/gurumohan123/AMDAcceleratorCloudGuides/assets/137781570/ecd69ae6-2002-46fe-bd10-6b8bb175a461)
Click on download option and download daemon logs.
...
Click on CLOSE and select STDOUT option for the output of any application(for ex: Throughput or Images/sec..etc)
![STDOUT](https://github.com/gurumohan123/AMDAcceleratorCloudGuides/assets/137781570/682938f0-4646-42c9-a747-269b197249da)
Select the download option for downloding STDOUT logs(example log file name: job-8872-logs.tar)
...
Click on STDERR for getting the errors of any application .
